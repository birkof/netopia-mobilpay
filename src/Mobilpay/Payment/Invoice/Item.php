...
namespace Mobilpay\Payment\Invoice;
...
class Item
{
    ...
    protected function loadFromXml(\DOMNode $elem)
    {
        ...
        if ($elems->length != 1) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid code element.',
        ...
        if ($elems->length != 1) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid name element.',
        ...
        if ($elems->length != 1) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid quantity element.',
        ...
        if ($this->quantity == 0) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid quantity value='.$this->quantity,
        ...
        if ($elems->length != 1) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid price element.',
        ...
        if ($this->price == 0) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid price value='.$this->price,
        ...
        if ($elems->length != 1) {
            throw new \Exception(
                'Mobilpay\Payment\Invoice\Item::loadFromXml failed! Invalid vat element.',

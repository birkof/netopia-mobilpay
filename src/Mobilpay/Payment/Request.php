...
class Request
{
    ...
    /**
     * m_service (Mandatory)    - signature received from mobilpay.ro thet identifies the online service for which you
     * are requesting a payment
     */
    public $m_service = null;

    /**
     * m_tran_id (Mandatory)    - payment transaction generated by seller; helps seller to interpret a request to
     * return url; it should be unique for the specified service
     *
     * @var string(64)
     */
    ...
    /**
     * m_timetsamp (Mandatory)    - merchant's site datetime when the transaction was generated expressed as
     * YYYYMMDDhhmmss
     *
     * @var string
     */
    ...
    /**
     * m_msisdn    (Optional)        - MSISDN (mobile phone numner) of the customer. If it's supplied it should be in
     * 07XXXXXXXX format. If it's supplied mobilpay.ro will use it for checking if payment is allowed for the specified
     * service automaticaly
     *
     * @var string(10)
     */

...
class Sms extends RequestAbstract
{
    ...
    /**
     * mobilePhone    (Optional)        - MSISDN (mobile phone numner) of the customer. If it's supplied it should be
     * in 07XXXXXXXX format. If it's supplied mobilpay.ro will autocomplete mobile phone field on payment interface
     *
     * @var string(10)
     */
    public $msisdn = null;

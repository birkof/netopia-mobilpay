...
use Mobilpay\Payment\Exchange\Rate;
use Mobilpay\Payment\Invoice\Item;
...
class Invoice
{
    ...
    public function addHeadExchangeRate(Rate $rate)
    {
    ...
    public function addTailExchangeRate(Rate $rate)
    {
